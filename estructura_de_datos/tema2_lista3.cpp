// Programa que permite el manejo de pacientes en un hospital
#include<iostream>
#include<cstdlib>
#include<string.h>
#define maxchar 50
...
struct nodo{
    ...
    long long telefono; // campo que almacena el telefono
    struct nodo *sgte;
...
void copiar_datos_paciente(PLista lista){
    ...
    cout<<"\n\n\n\t--------------------------------";
    cout<<"\n\n\tINGRESE CODIGO DE PACIENTE A COPIAR:"; 
    cin>>cod1;
    cout<<"\n\n\tINGRESE CODIGO DE PACIENTE A SUSTITUIR:";
    cin>>cod2;
    system("cls");
